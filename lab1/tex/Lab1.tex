...
\begin{itemize}
    \item Ознакомиться с различными методами калибровки камеры
    \item Сделать снимки с использованием своей или аудиторной камеры
    \item Выполнить калибровку камеры по полученным изображениям
    \item Рассчитать метрики полученной калибровки
    \item Реализовать выравнивание изображения в реальном времени
    \item Защитить решение от преподавателя
\end{itemize}

\subsection*{Продвинутый уровень}
\begin{itemize}
    \item Реализовать метод DLT или Чжана
\end{itemize}
...
\begin{itemize}
\item{Computer Vision: Camera Calibration with OpenCV - более подробно разобранный процесс калибровки}

\url{https://www.youtube.com/watch?v=KGeRoScMs6Q}
